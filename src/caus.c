...
//      printf("System command error:\n);
    ...
    memset(syscmd,'\0',2000);
    sprintf(syscmd,"%s/caus_shred -name input -length %d input.fasta input.shred > try.out",bindir,len_shred);
    if(system(syscmd) == -1)
    {
//      printf("System command error:\n);
    }
